...
<?php echo form_open('rmadd/'.$guild->id) ?>
<script>
    <?php
...
<div class="row">
    <div class="col-12">
        <div class="p-3" style="border: 2px solid; border-color: white">
            ...
            <input placeholder='Nom' type="text" name="rmname" class="inputname" required minlength="1" maxlength="50"></input>
            <br /><br />

            <p>Message :</p>
            <textarea name='messagecontent' cols="60" rows="13" class='textareamsg' placeholder="🍌 Rôle Banane
🍎 Rôle Pomme

Clique sur un rôle pour attribuer un fruit !" required minlength="1" maxlength="2000"></textarea><br /><br />

            <br />
            <div class="ml-1 button b2" id="button-10" style='border: 1px solid; border-color: white'>
                <input type="checkbox" class="checkbox" name="buttons"/>
                <div class="knobs">
                    <span>Emoji</span>
                </div>
                <div class="layer"></div>
